...
export default defineConfig({
  ...
  webServer: [
    { command: 'python3 -m uvicorn agentgate.server.app:app --host 127.0.0.1 --port 18000', port: 18000, reuseExistingServer: false, env: { ...process.env, AGENTGATE_DB: testDatabase, PYTHONPATH: '../src' } },
